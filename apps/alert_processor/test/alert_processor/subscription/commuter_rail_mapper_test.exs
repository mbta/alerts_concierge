defmodule AlertProcessor.Subscription.CommuterRailMapperTest do
  ...
  describe "map_subscriptions one way" do
    ...
    test "constructs subscription with route" do
      ...
      route_entity_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "CR-Lowell", route_type: 2, stop: nil, direction_id: nil},
            informed_entity
          )
        end)
      ...
      route_entity_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "CR-Lowell", route_type: 2, stop: nil, direction_id: 1},
            informed_entity
          )
        end)
    ...
    test "constructs subscription with route in other direction" do
      reverse_trip_params =
        Map.merge(@one_way_params, %{
          "destination" => "Anderson/ Woburn",
          "origin" => "place-north",
          "direction_id" => "0"
        })

      {:ok, [{_sub, informed_entities}]} =
        CommuterRailMapper.map_subscriptions(reverse_trip_params)
      ...
      route_entity_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "CR-Lowell", route_type: 2, stop: nil, direction_id: 0},
            informed_entity
          )
        end)
    ...
    test "constructs subscription with stops" do
      ...
      mishawum_station_with_direction_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "CR-Lowell", route_type: 2, stop: "Mishawum", direction_id: 1},
            informed_entity
          )
        end)
  ...
  describe "map_subscriptions round trip" do
    ...
    test "constructs subscription with stops" do
      ...
      mishawum_station_with_direction_count =
        Enum.count(ie1, fn informed_entity ->
          match?(
            %InformedEntity{route: "CR-Lowell", route_type: 2, stop: "Mishawum", direction_id: 0},
            informed_entity
          )
        end)
  ...
  describe "map_trip_options" do
    ...
    test "returns inbound results for origin destination" do
      use_cassette "north_to_anderson_woburn_schedules",
        custom: true,
        clear_mock: true,
        match_requests_on: [:query] do
        {:ok, trips} =
          CommuterRailMapper.map_trip_options(
            "place-north",
            "Anderson/ Woburn",
            :weekday,
            @test_date
        ...
        assert [
                 %TripInfo{
                   trip_number: "301",
                   departure_time: ~T[05:35:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[05:59:00]
                 },
                 %TripInfo{
                   trip_number: "303",
                   departure_time: ~T[06:15:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[06:34:00]
                 },
                 %TripInfo{
                   trip_number: "305",
                   departure_time: ~T[06:37:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[07:01:00]
                 },
                 %TripInfo{
                   trip_number: "307",
                   departure_time: ~T[07:21:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[07:45:00]
                 },
                 %TripInfo{
                   trip_number: "391",
                   departure_time: ~T[07:42:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[08:02:00]
                 },
                 %TripInfo{
                   trip_number: "309",
                   departure_time: ~T[08:16:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[08:40:00]
                 },
                 %TripInfo{
                   trip_number: "311",
                   departure_time: ~T[09:15:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[09:39:00]
                 },
                 %TripInfo{
                   trip_number: "313",
                   departure_time: ~T[10:15:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[10:39:00]
                 },
                 %TripInfo{
                   trip_number: "315",
                   ...
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[11:39:00]
                 },
                 %TripInfo{
                   trip_number: "317",
                   departure_time: ~T[12:15:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[12:39:00]
                 },
                 %TripInfo{
                   trip_number: "319",
                   departure_time: ~T[13:15:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[13:39:00]
                 }
                 | rest
               ] = trips
        ...
        assert [
                 %TripInfo{
                   trip_number: "321",
                   departure_time: ~T[14:15:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[14:39:00]
                 },
                 %TripInfo{
                   trip_number: "323",
                   departure_time: ~T[15:00:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[15:24:00]
                 },
                 %TripInfo{
                   trip_number: "325",
                   departure_time: ~T[15:40:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[16:05:00]
                 },
                 %TripInfo{
                   trip_number: "327",
                   departure_time: ~T[16:15:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                 ...
                 %TripInfo{
                   trip_number: "329",
                   departure_time: ~T[16:45:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[17:10:00]
                 },
                 %TripInfo{
                   trip_number: "331",
                   departure_time: ~T[17:10:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[17:35:00]
                 },
                 %TripInfo{
                   trip_number: "333",
                   departure_time: ~T[17:35:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[17:54:00]
                 },
                 %TripInfo{
                   trip_number: "335",
                   departure_time: ~T[17:50:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                 ...
                 %TripInfo{
                   trip_number: "337",
                   departure_time: ~T[18:30:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[18:55:00]
                 },
                 %TripInfo{
                   trip_number: "221",
                   departure_time: ~T[18:55:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[19:20:00]
                 },
                 %TripInfo{
                   trip_number: "339",
                   departure_time: ~T[19:25:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[19:49:00]
                 },
                 %TripInfo{
                   trip_number: "341",
                   departure_time: ~T[20:35:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[20:59:00]
                 },
                 %TripInfo{
                   trip_number: "343",
                   departure_time: ~T[21:45:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[22:09:00]
                 },
                 %TripInfo{
                   trip_number: "345",
                   departure_time: ~T[22:55:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[23:19:00]
                 },
                 %TripInfo{
                   trip_number: "347",
                   departure_time: ~T[00:15:00],
                   direction_id: 0,
                   origin: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   destination:
                     {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   arrival_time: ~T[00:39:00]
                 }
               ] = rest
      end
    end
    ...
    test "returns outbound results for origin destination" do
      use_cassette "anderson_woburn_to_north_schedules",
        custom: true,
        clear_mock: true,
        match_requests_on: [:query] do
        {:ok, trips} =
        ...
        assert [
                 %TripInfo{
                   trip_number: "300",
                   departure_time: ~T[05:56:00],
                   direction_id: 1,
                   origin: {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   destination: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   arrival_time: ~T[06:22:00]
                 },
                 %TripInfo{
                   trip_number: "302",
                   departure_time: ~T[06:36:00],
                   direction_id: 1,
                   origin: {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   destination: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   arrival_time: ~T[07:01:00]
                 ...
                 %TripInfo{
                   trip_number: "304",
                   departure_time: ~T[07:01:00],
                   direction_id: 1,
                   origin: {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   destination: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   arrival_time: ~T[07:27:00]
                 },
                 %TripInfo{
                   trip_number: "306",
                   departure_time: ~T[07:19:00],
                   direction_id: 1,
                   origin: {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   destination: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   arrival_time: ~T[07:47:00]
                 },
                 %TripInfo{
                   trip_number: "308",
                   departure_time: ~T[07:41:00],
                   direction_id: 1,
                   origin: {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   destination: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   arrival_time: ~T[08:06:00]
                 },
                 %TripInfo{
                   trip_number: "310",
                   departure_time: ~T[08:01:00],
                   direction_id: 1,
                   origin: {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   destination: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   arrival_time: ~T[08:21:00]
                 },
                 %TripInfo{
                   trip_number: "392",
                   departure_time: ~T[08:21:00],
                   direction_id: 1,
                   origin: {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   destination: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   arrival_time: ~T[08:47:00]
                 },
                 %TripInfo{
                   trip_number: "312",
                   departure_time: ~T[08:41:00],
                   direction_id: 1,
                   origin: {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   destination: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   arrival_time: ~T[09:06:00]
                 },
                 %TripInfo{
                   trip_number: "314",
                   departure_time: ~T[09:06:00],
                   direction_id: 1,
                   origin: {"Anderson/Woburn", "Anderson/ Woburn", {42.516987, -71.144475}, 1},
                   destination: {"North Station", "place-north", {42.365577, -71.06129}, 1},
                   arrival_time: ~T[09:31:00]
                 }
                 | _t
               ] = trips
      end
    ...
    test "returns saturday results" do
      use_cassette "waltham_to_porter_schedules",
        custom: true,
        clear_mock: true,
        match_requests_on: [:query] do
        {:ok, trips} =
          CommuterRailMapper.map_trip_options("Waltham", "place-portr", :saturday, @test_date)

        assert [
                 %TripInfo{
                   trip_number: "1400",
                   departure_time: ~T[07:38:00],
                   direction_id: 1,
                   origin: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   destination: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   arrival_time: ~T[07:50:00]
                 },
                 %TripInfo{
                   trip_number: "1402",
                   departure_time: ~T[09:53:00],
                   direction_id: 1,
                   origin: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   destination: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   arrival_time: ~T[10:05:00]
                 },
                 %TripInfo{
                   trip_number: "1404",
                   departure_time: ~T[11:58:00],
                   direction_id: 1,
                   origin: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   destination: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   arrival_time: ~T[12:10:00]
                 },
                 %TripInfo{
                   trip_number: "1406",
                   departure_time: ~T[14:23:00],
                   direction_id: 1,
                   origin: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   destination: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   arrival_time: ~T[14:35:00]
                 },
                 %TripInfo{
                   trip_number: "1408",
                   departure_time: ~T[16:48:00],
                   direction_id: 1,
                   origin: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   destination: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   arrival_time: ~T[17:00:00]
                 },
                 %TripInfo{
                   trip_number: "1410",
                   departure_time: ~T[19:18:00],
                   direction_id: 1,
                   origin: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   destination: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   arrival_time: ~T[19:30:00]
                 },
                 %TripInfo{
                   trip_number: "1412",
                   departure_time: ~T[22:53:00],
                   direction_id: 1,
                   origin: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   destination: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   arrival_time: ~T[23:05:00]
                 }
                 | _t
               ] = trips
      end
    ...
    test "returns sunday results" do
      use_cassette "porter_to_waltham_schedules",
        custom: true,
        clear_mock: true,
        match_requests_on: [:query] do
        {:ok, trips} =
          CommuterRailMapper.map_trip_options("place-portr", "Waltham", :sunday, @test_date)

        assert [
                 %TripInfo{
                   trip_number: "2401",
                   departure_time: ~T[08:45:00],
                   direction_id: 0,
                   origin: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   destination: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   arrival_time: ~T[08:57:00]
                 },
                 %TripInfo{
                   trip_number: "2403",
                   departure_time: ~T[10:55:00],
                   direction_id: 0,
                   origin: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   destination: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   arrival_time: ~T[11:07:00]
                 },
                 %TripInfo{
                   trip_number: "2405",
                   departure_time: ~T[13:20:00],
                   direction_id: 0,
                   origin: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   destination: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   arrival_time: ~T[13:32:00]
                 },
                 %TripInfo{
                   trip_number: "2407",
                   departure_time: ~T[15:40:00],
                   ...
                   origin: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   destination: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   arrival_time: ~T[15:52:00]
                 },
                 %TripInfo{
                   trip_number: "2409",
                   departure_time: ~T[17:55:00],
                   direction_id: 0,
                   origin: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   destination: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   arrival_time: ~T[18:07:00]
                 },
                 %TripInfo{
                   trip_number: "2411",
                   departure_time: ~T[20:05:00],
                   direction_id: 0,
                   origin: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   destination: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   arrival_time: ~T[20:17:00]
                 },
                 %TripInfo{
                   trip_number: "2413",
                   departure_time: ~T[23:40:00],
                   direction_id: 0,
                   origin: {"Porter", "place-portr", {42.3884, -71.119149}, 1},
                   destination: {"Waltham", "Waltham", {42.374269, -71.235598}, 1},
                   arrival_time: ~T[23:52:00]
                 }
               ] = trips
      end
    end
  ...
  describe "get_trip_info" do
    test "returns trip options with closest trip preselected" do
      {:ok, trips} =
        CommuterRailMapper.get_trip_info("Reading", "place-north", :weekday, "10:00:00")

      assert [
               %AlertProcessor.Model.TripInfo{trip_number: "200", selected: false},
               ...
               %AlertProcessor.Model.TripInfo{trip_number: "228", selected: false}
             ] = trips
    end

    test "returns trip options with preselected values" do
      {:ok, trips} =
        CommuterRailMapper.get_trip_info("Reading", "place-north", :weekday, ["286", "298"])
    ...
    test "returns error if origin/destination are not on the same route" do
      :error =
        CommuterRailMapper.get_trip_info("Anderson/ Woburn", "place-rugg", :sunday, "10:00:00")

      :error =
        CommuterRailMapper.get_trip_info("Anderson/ Woburn", "place-rugg", :sunday, [
          "2302",
          "2308"
        ])
    end
  ...
  describe "populate_trip_options one_way" do
    test "one_way with timestamp returns trip options with closest trip preselected" do
      ...
      {:ok, %{departure_trips: departure_trips}} =
        CommuterRailMapper.populate_trip_options(params)

      selected_trips = Enum.filter(departure_trips, & &1.selected)

      assert [%TripInfo{trip_number: "316", departure_time: ~T[09:36:00], selected: true}] =
               selected_trips
    end
  ...
  describe "trip_schedule_info_map" do
    ...
    test "maps schedule info between two stations on weekday" do
      use_cassette "trip_schedule_info_weekday_commuter_rail",
        custom: true,
        clear_mock: true,
        match_requests_on: [:query] do
        trip_schedule_info_map =
          CommuterRailMapper.trip_schedule_info_map("Newburyport", "Rowley", :weekday, @test_date)
    ...
    test "maps schedule info between two stations on saturday" do
      use_cassette "trip_schedule_info_saturday_commuter_rail",
        custom: true,
        clear_mock: true,
        match_requests_on: [:query] do
        trip_schedule_info_map =
          CommuterRailMapper.trip_schedule_info_map(
            "place-north",
            "Fitchburg",
            :saturday,
            @test_date
    ...
    test "maps schedule info between two stations on sunday" do
      use_cassette "trip_schedule_info_sunday_commuter_rail",
        custom: true,
        clear_mock: true,
        match_requests_on: [:query] do
        trip_schedule_info_map =
  ...
  describe "build_update_subscription_transaction" do
    test "it builds a multi struct to update subscription" do
      ...
      multi =
        CommuterRailMapper.build_update_subscription_transaction(subscription, params, user.id)
