defmodule AlertProcessor.Subscription.SubwayMapperTest do
  ...
  describe "one way" do
    ...
    test "constructs subscription with route in other direction" do
      reverse_trip_params =
        Map.merge(@one_way_params, %{"destination" => "place-davis", "origin" => "place-harsq"})
  ...
  describe "round trip" do
    ...
    test "constructs subscription with route" do
      ...
      route_entity_count =
        Enum.count(ie1, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: nil, direction_id: nil},
            informed_entity
          )
        end)
      ...
      route_entity_count =
        Enum.count(ie1, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: nil, direction_id: 0},
            informed_entity
          )
        end)
      ...
      route_entity_count =
        Enum.count(ie2, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: nil, direction_id: 1},
            informed_entity
          )
        end)
    ...
    test "works for northbound departure trip" do
      {:ok, [{_sub1, ie1}, {_sub2, ie2}]} =
        SubwayMapper.map_subscriptions(
          Map.merge(@round_trip_params, %{
            "origin" => "place-rcmnl",
            "destination" => "place-tumnl"
          })
        )
      ...
      route_entity_count =
        Enum.count(ie1, fn informed_entity ->
          match?(
            %InformedEntity{route: "Orange", route_type: 1, stop: nil, direction_id: nil},
            informed_entity
          )
        end)
      ...
      route_entity_count =
        Enum.count(ie1, fn informed_entity ->
          match?(
            %InformedEntity{route: "Orange", route_type: 1, stop: nil, direction_id: 1},
            informed_entity
          )
        end)
      ...
      route_entity_count =
        Enum.count(ie2, fn informed_entity ->
          match?(
            %InformedEntity{route: "Orange", route_type: 1, stop: nil, direction_id: 0},
            informed_entity
          )
        end)
    ...
    test "constructs subscription with stops" do
      ...
      davis_station_count =
        Enum.count(ie2, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-davis", direction_id: nil},
            informed_entity
          )
        end)
      ...
      porter_station_count =
        Enum.count(ie2, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-portr", direction_id: nil},
            informed_entity
          )
        end)
      ...
      harvard_station_count =
        Enum.count(ie2, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-harsq", direction_id: nil},
            informed_entity
          )
        end)
      ...
      davis_station_with_direction_count =
        Enum.count(ie2, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-davis", direction_id: 1},
            informed_entity
          )
        end)
      ...
      porter_station_with_direction_count =
        Enum.count(ie2, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-portr", direction_id: 1},
            informed_entity
          )
        end)
      ...
      harvard_station_with_direction_count =
        Enum.count(ie2, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-harsq", direction_id: 1},
            informed_entity
          )
        end)
  ...
  describe "green line" do
    ...
    test "constructs subscription with route" do
      {:ok, [{_sub, informed_entities}]} =
        SubwayMapper.map_subscriptions(@green_line_one_way_params)

      route_entity_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Green-" <> _, route_type: 0, stop: nil, direction_id: nil},
            informed_entity
          )
        end)
      ...
      route_entity_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Green-" <> _, route_type: 0, stop: nil, direction_id: 0},
            informed_entity
          )
        end)
  ...
  describe "roaming" do
    ...
    test "constructs subscription with stops" do
      ...
      alewife_station_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-alfcl", direction_id: nil},
            informed_entity
          )
        end)
      ...
      central_station_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-censq", direction_id: nil},
            informed_entity
          )
        end)
      ...
      davis_station_0_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-davis", direction_id: 0},
            informed_entity
          )
        end)
      ...
      davis_station_0_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-portr", direction_id: 0},
            informed_entity
          )
        end)
      ...
      harvard_station_0_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-harsq", direction_id: 0},
            informed_entity
          )
        end)
      ...
      alewife_station_0_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-alfcl", direction_id: 0},
            informed_entity
          )
        end)
      ...
      central_station_0_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-censq", direction_id: 0},
            informed_entity
          )
        end)
      ...
      alewife_station_1_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-alfcl", direction_id: 1},
            informed_entity
          )
        end)
      ...
      central_station_1_count =
        Enum.count(informed_entities, fn informed_entity ->
          match?(
            %InformedEntity{route: "Red", route_type: 1, stop: "place-censq", direction_id: 1},
            informed_entity
          )
        end)
