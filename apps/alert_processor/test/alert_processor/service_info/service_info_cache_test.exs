defmodule AlertProcessor.ServiceInfoCacheTest do
  ...
  test "get_commuter_rail_info/0 returns commuter rail info" do
    use_cassette "service_info", custom: true, clear_mock: true, match_requests_on: [:query] do
      ...
      assert [
        %Route{route_id: "CR-Fairmount", long_name: "Fairmount Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Readville", "Readville", _, _} | _]},
        %Route{route_id: "CR-Fitchburg", long_name: "Fitchburg Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Wachusett", "Wachusett", _, _} | _]},
        %Route{route_id: "CR-Worcester", long_name: "Framingham/Worcester Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Worcester", "Worcester", _, _} | _]},
        %Route{route_id: "CR-Franklin", long_name: "Franklin Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Forge Park/495", "Forge Park / 495", _, _} | _]},
        %Route{route_id: "CR-Greenbush", long_name: "Greenbush Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Greenbush", "Greenbush", _, _} | _]},
        %Route{route_id: "CR-Haverhill", long_name: "Haverhill Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Haverhill", "Haverhill", _, _} | _]},
        %Route{route_id: "CR-Kingston", long_name: "Kingston/Plymouth Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Plymouth", "Plymouth", _, _} | _]},
        %Route{route_id: "CR-Lowell", long_name: "Lowell Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Lowell", "Lowell", _, _} | _]},
        %Route{route_id: "CR-Middleborough", long_name: "Middleborough/Lakeville Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Middleborough/Lakeville",
                "Middleborough/ Lakeville", _, _} | _]},
        %Route{route_id: "CR-Needham", long_name: "Needham Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Needham Heights", "Needham Heights", _, _} | _]},
        %Route{route_id: "CR-Newburyport", long_name: "Newburyport/Rockport Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Rockport", "Rockport", _, _} | _]},
        %Route{route_id: "CR-Providence", long_name: "Providence/Stoughton Line", route_type: 2, direction_names: ["Outbound", "Inbound"], stop_list: [{"Wickford Junction", "Wickford Junction", _, _} | _]}
      ] = route_info
    end
  end
  ...
  test "get_ferry_info/0 returns ferry info" do
    use_cassette "service_info", custom: true, clear_mock: true, match_requests_on: [:query] do
      ...
      assert [
        %Route{route_id: "Boat-F4", long_name: "Charlestown Ferry", route_type: 4, direction_names: ["Outbound", "Inbound"], stop_list: [{"Charlestown Navy Yard", "Boat-Charlestown", _, _} | _]},
        %Route{route_id: "Boat-F1", long_name: "Hingham Ferry", route_type: 4, direction_names: ["Outbound", "Inbound"], stop_list: [{"Hewitt's Cove, Hingham", "Boat-Hingham", _, _} | _]},
        %Route{route_id: "Boat-F3", long_name: "Hull Ferry", route_type: 4, direction_names: ["Outbound", "Inbound"], stop_list: [{"Pemberton Point, Hull", "Boat-Hull", _, _} | _]}
      ] = route_info
    end
  end
  ...
  test "get_headsign :subway returns the correct headsigns" do
    use_cassette "service_info", custom: true, clear_mock: true, match_requests_on: [:query] do
      ...
      assert {:ok, "Ashmont or Braintree"} == ServiceInfoCache.get_headsign(pid, "place-davis", "place-pktrm", 0)
      ...
      assert {:ok, "B, C, D, or E"} == ServiceInfoCache.get_headsign(pid, "place-gover", "place-haecl", 0)
