defmodule AlertProcessor.ServiceInfoCacheTest do
  ...
  test "get_trip_name", %{pid: pid} do
    assert {:ok, "900"} = ServiceInfoCache.get_trip_name(pid, "CR-Weekday-Fall-17-900")
  end
