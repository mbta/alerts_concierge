defmodule ConciergeSite.SubscriptionViewTest do
  ...
  describe "sorted_subscription/1" do
    test "sorted_subscriptions groups subscriptions by mode" do
      ...
      assert %{ferry: [], bus: [^sub2, ^sub4], commuter_rail: [], subway: [^sub1, ^sub3]} = SubscriptionView.sorted_subscriptions([sub1, sub2, sub3, sub4])
    end
    ...
    test "sorted_subscriptions groups subscriptions by line" do
      ...
      assert %{ferry: [], bus: [], commuter_rail: [], subway: [^sub1, ^sub3, ^sub2, ^sub5, ^sub4, ^sub6]} = SubscriptionView.sorted_subscriptions([sub1, sub2, sub3, sub4, sub5, sub6])
    end
    ...
    test "sorted_subscriptions sorts by earliest start_time" do
      ...
      assert %{ ferry: [], bus: [], commuter_rail: [], subway: [^sub3, ^sub2, ^sub1]} = SubscriptionView.sorted_subscriptions([sub1, sub2, sub3])
    end
    ...
    test "sorted_subscriptions sorts by relevant days" do
      ...
      assert %{ferry: [], bus: [], commuter_rail: [], subway: [^sub4, ^sub5, ^sub6, ^sub1, ^sub2, ^sub3]} = SubscriptionView.sorted_subscriptions(Enum.shuffle([sub1, sub2, sub3, sub4, sub5, sub6]))
    end
  end
