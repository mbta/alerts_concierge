defmodule ConciergeSite.StopSelectHelperTest do
  ...
  test "render/3 Subway Line" do
    ...
    assert html =~
             "<option data-bus=\"true\" data-mattapan=\"true\" data-red=\"true\" data-red-1=\"true\" value=\"place-asmnl\">Ashmont</option>"

    assert html =~
             "<option data-green-b=\"true\" data-green-c=\"true\" data-green-d=\"true\" data-green-e=\"true\" data-red=\"true\" data-red-1=\"true\" data-red-2=\"true\" value=\"place-pktrm\">Park Street</option>"

    assert html =~
             "<option data-orange=\"true\" data-red=\"true\" data-red-1=\"true\" data-red-2=\"true\" value=\"place-dwnxg\">Downtown Crossing</option>"

    assert html =~
             "<option data-bus=\"true\" data-cr=\"true\" data-red=\"true\" data-red-2=\"true\" value=\"place-brntn\">Braintree</option>"
  end
  ...
  test "render/3 Commuter Rail" do
    ...
    assert html =~
             "<option data-bus=\"true\" data-cr=\"true\" data-orange=\"true\" value=\"place-mlmnl\">Malden Center</option>"
  end
  ...
  test "render/3 Mattapan" do
    ...
    assert html =~
             "<option data-bus=\"true\" data-mattapan=\"true\" data-red=\"true\" value=\"place-asmnl\">Ashmont</option>"
  end
  ...
  test "render/3 Green-B" do
    ...
    assert html =~
             "<option data-green-b=\"true\" data-green-c=\"true\" data-green-d=\"true\" data-green-e=\"true\" data-red=\"true\" value=\"place-pktrm\">Park Street</option>"
  end
  ...
  test "render/4 Orange with pre-selection" do
    ...
    assert html =~
             "<option data-bus=\"true\" data-cr=\"true\" data-orange=\"true\" selected=\"selected\" value=\"place-ogmnl\">Oak Grove</option>"
  end
