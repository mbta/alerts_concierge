defmodule ConciergeSite.IconViewHelper do
  ...
  def icon(:bus) do
    raw("""
    <svg width="27" height="27" fill="#000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
  ...
  def icon(:commuter_rail) do
    raw("""
    <svg width="27" height="27" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45">
