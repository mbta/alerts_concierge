defmodule ConciergeSite.FacilitiesHelper do
  ...
  @spec facility_checkbox(Phoenix.HTML.Form.t | atom, Trip.t, atom, String.t) :: Phoenix.HTML.safe
  ...
  defp checkbox_content(form, trip, facility_type, name) do
    [
      icon(facility_type),
      checkbox(form, facility_type, value: facility_type_value(trip, facility_type), tabindex: "-1"),
