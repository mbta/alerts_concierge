const icons = {
  accessible: className => `<svg width="20" height="20" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" class="${className}">
  ...
  "green-b": className =>
    `<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="${className}">
  ...
  mattapan: className =>
    `<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" class="${className}">
      <g fill="none" fill-rule="evenodd">
