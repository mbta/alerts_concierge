const getSubwayIcon = (color, className) =>
  `<svg width="27" height="27" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" class="${className}">
...
const icons = {
  accessible: className => `<svg width="27" height="27" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" class="${className}">
  ...
  bus: className => `<svg width="27" height="27" fill="#000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" class="${className}">
  ...
  cr: className => `<svg width="27" height="27" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" class="${className}">
  ...
  mattapan: className => `<svg width="27" height="27" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" class="${className}">
  ...
  ferry: className => `<svg width="27" height="27" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" class="${className}">
