const getSubwayIcon = color =>
  `<svg width="30" height="30" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" style="float: left">
...
const icons = {
  red: getSubwayIcon("#da291c"),
  blue: getSubwayIcon("#003da5"),
  orange: getSubwayIcon("#ed8b00"),
  green: getSubwayIcon("#00843d"),
  bus: `<svg width="30" height="30" fill="#000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" style="float: left">
  ...
  cr: `<svg width="30" height="30" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" style="float: left">
  ...
  mattapan: `<svg width="30" height="30" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" style="float: left">
  ...
  ferry: `<svg width="30" height="30" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" style="float: left">
