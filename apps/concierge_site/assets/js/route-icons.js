const getSubwayIcon = (color, className) =>
  `<svg width="30" height="30" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" class="${className}">
...
const icons = {
  accessible: className => `<svg width="30" height="30" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" class="${className}">
  ...
  red: className => getSubwayIcon("#da291c", className),
  blue: className => getSubwayIcon("#003da5", className),
  orange: className => getSubwayIcon("#ed8b00", className),
  green: className => getSubwayIcon("#00843d", className),
  bus: className => `<svg width="30" height="30" fill="#000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" class="${className}">
  ...
  cr: className => `<svg width="30" height="30" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" class="${className}">
  ...
  mattapan: className => `<svg width="30" height="30" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" class="${className}">
  ...
  ferry: className => `<svg width="30" height="30" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" class="${className}">
